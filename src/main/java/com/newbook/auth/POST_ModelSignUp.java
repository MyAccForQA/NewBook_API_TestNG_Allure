...
public class POST_ModelSignUp extends Base {

	public final static String MODEL_SIGNUP_URL = "/auth/model/signup/";
	// for save
	private RequestSpecification request = null;
	private io.restassured.response.Response response = null;

	// constructor START!!!!!!!!!!!!!!!!!!!!!!!
	public POST_ModelSignUp(String email, String pass, String mess) {
	...
	////////////////////////////// private START//////////////////////////////
	// RUN all methods
	@Step("SignUp {2} - [POST " + MODEL_SIGNUP_URL + "]...")
	...
	// Create response
	@Step("Create response for signup  with email=[{0}]")
	private void createResponse(JSONObject json) {
		...
		sendPostRequest(getBaseURL() + getModelSignUpURL());
	}
	...
	@Step("getModelSignUpURL")
	private String getModelSignUpURL() {
		return MODEL_SIGNUP_URL;
	}
	////////////////////////////// private END//////////////////////////////
