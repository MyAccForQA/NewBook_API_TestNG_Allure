...
public class PATCH_ModelUpdateSelfUserData extends Base {

	public final static String SELFUSERDATA_URL = "/model/self/";
	// for save
	private RequestSpecification request = null;
	private Response response = null;

	// constructor START!!!!!!!!!!!!!!!!!!!!!!!
	public PATCH_ModelUpdateSelfUserData(String token, String key, String value, String mess) {
