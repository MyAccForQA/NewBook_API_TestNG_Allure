...
public class SimpleFromNewTest_NoRun {
	/*
	@Step("testSignIn with '@DataBinding'")
	@DataBinding()
	@Test(groups = "csv")
	public void testSignIn_WithDataBinding_WithCSV(@TestInput(name = "email") int email,
			@TestInput(name = "pass") int pass, @TestInput(name = "mess") int mess, @TestOutput(name = "code") int code)
			throws Exception {

		assertEquals(email + pass, code, "ERROR!!!");
		
		// SignIn signIn = new SignIn(email, pass, mess);
		// assertEquals(signIn.getStatus(), "" + code, "ERROR!!!");
	}*/
	
    @Test
    public void simpleTest() throws Exception {
    	System.out.println("SimpleFromNewTest");
